...
export const categories = [
  ...
  },
  {
    text: "Frozen Foods",
    path: "Frozen Foods",
    image: grain_image, // Replace with actual frozen food image
    bgColor: "#F1E3F9",
  },
  {
    text: "Fruits & Vegetables",
    path: "Fruits & Vegetables",
    image: organic_vegitable_image, // Or fresh_fruits_image
    bgColor: "#FEF6DA",
  },
  {
    text: "Ready-to-Eat Meals",
    path: "Ready-to-Eat Meals",
    image: maggi_image, // Replace with actual image
    bgColor: "#E1F5EC",
  },
  {
    text: "Packaged Foods",
    path: "Packaged Foods",
    image: upload_area, // Replace with actual packaged food image
    bgColor: "#FEE0E0",
  },
  {
    text: "Fresh Juices",
    path: "Fresh Juices",
    image: bottles_image, // Replace with actual juice image
    bgColor: "#E0F6FE",
  },
  {
    text: "Condiments & Sauces",
    path: "Condiments & Sauces",
    image: knorr_soup_image, // Replace with sauces image if available
    bgColor: "#FEE6CD",
  },
  {
    text: "Fermented Products",
    path: "Fermented Products",
    image: yippee_image, // Replace with actual fermented products image
    bgColor: "#F1E3F9",
  },
];
